...
(function(root){
  ...
  const PROLOGUE={
    ...
    nodes:{
      ...
      ,chapter1_ring:{id:"chapter1_ring",progress:chapterProgress(6),goal:textGoal("查看黄色圆环"),dialogue:{speaker:"我",sub:"洞窟祭坛",pages:["祭坛上摆着一个泛着诡异光泽的黄色圆环。"],choices:[{id:"eat",label:"吃掉黄色圆环",action:"takeRing",next:"chapter1_ring_tutorial"},{id:"leave",label:"离开",next:"chapter1_explore"}]}}
      ,chapter1_ring_tutorial:{id:"chapter1_ring_tutorial",progress:chapterProgress(6),goal:textGoal("了解环形节点"),dialogue:{speaker:"教学",sub:"获得环形节点",pages:["你获得了 1 点环形节点充能。","环形节点能让你从自己的身体上安全穿过，帮助你闭合包围并困住敌人。","按 {node} 在蛇头当前位置放置节点，再引导蛇头从节点处穿过自己的身体。尾巴完全通过后，节点会自动回收。","被困的敌人会攻击节点；节点被摧毁时，这点充能也会失去。","祭坛后方传来一声巨响，墙壁塌落，露出了通往洞口附近的旧通道。"],choices:[{id:"continue",label:"明白了",next:"chapter1_explore"}]}}
    }
  };

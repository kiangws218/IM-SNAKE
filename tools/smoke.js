...
try{
  ...
  sandbox.__IMS.enemies[0].hp=3;sandbox.__IMS.enemies[0].x=46.25;sandbox.__IMS.snake.fx=3;sandbox.__IMS.snake.fy=16;frames(2);sandbox.__IMS.snake.fx=84;sandbox.__IMS.snake.fy=10;frames(2);
  ...
  console.log("[chapter cave rescue + persistence + ring shortcut + bridge] OK");
